...
class TaskDeadlineApproachingNotification extends Notification implements ShouldQueue
{
    ...
    {
        return 'task.deadline_approaching';
    }

    public function toMail(object $notifiable): MailMessage
    {
        /** @var User $notifiable */
        $line = $this->deadlineApproachingLine($this->task, $notifiable);
    ...
    public function toTelegram(object $notifiable): TelegramMessage
    {
        ...
        return TelegramMessage::create()
            ->normal()
            ->content($this->deadlineApproachingLine($this->task, $notifiable))
            ->button(
                $this->localizedLine($notifiable, 'notification.open_task'),
                $this->taskUrl($this->task),
            );
